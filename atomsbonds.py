...
print(np.max(test_raw_cock_list[0:50]))
print(np.max(test_raw_cock_list[50:100]))
print(np.max(test_raw_cock_list[100:150]))
print(np.max(test_raw_cock_list[150:200]))
print(np.max(test_raw_cock_list[200:250]))

np.save("f:/Users/Montague/Desktop/DStuff/atomsbondsdatasets/atomsbondsrocaucresult", np.array(test_raw_cock_list))
